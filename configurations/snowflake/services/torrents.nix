    ...
    virtualisation.oci-containers.containers = {
      ...
      jackett =
        let
          ...
          service-version = "0.20.834"; # renovate: datasource=docker depName=linuxserver/jackett
          service-port = "9117";
        in
        {
      ...
      sonarr =
        let
          service-name = "sonarr";
          service-version = "3.0.7"; # renovate: datasource=docker depName=linuxserver/sonarr
          service-port = "8989";
        in
        {
